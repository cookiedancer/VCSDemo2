...
/**
 * Write a description of class BulletP2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class BulletP2 extends Actor
{
    /**
     * Act - do whatever the BulletP2 wants to do. This method is called whenever
    ...
    public void impact()
    {
        ...
        else if (isTouching(ShipP1.class))
        {
            getWorld().removeObject(this);
        }
